...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('D:/video_clip/output/diagnostic.log', encoding='utf-8'),
...
config = ProcessingConfig(
    output_dir=r"D:\video_clip\output\diagnostic_test",
    enable_demucs=True,
...
input_video = r"D:\个人资料\音乐测试\视频素材\live\周深\周深-VX-q97643800 (24).mp4"
